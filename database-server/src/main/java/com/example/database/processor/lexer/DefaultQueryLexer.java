...
public final class DefaultQueryLexer implements QueryLexer {
    ...
    private static final Map<String, TokenCatalog> KEYWORDS = Map.ofEntries(
            ...
            Map.entry("UNIQUE", TokenCatalog.UNIQUE),
            Map.entry("PRIMARY", TokenCatalog.PRIMARY),
            Map.entry("KEY", TokenCatalog.KEY),
            ...
            Map.entry("BEGIN", TokenCatalog.BEGIN),
            ...
            Map.entry("DATABASES", TokenCatalog.DATABASES),
            Map.entry("TABLES", TokenCatalog.TABLES),
